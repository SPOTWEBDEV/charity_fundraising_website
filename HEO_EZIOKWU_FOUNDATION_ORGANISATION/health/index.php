                ...
                <div class="row">
                    ...
                    <div class="single-item col-lg-6 col-md-6 mt-3">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo $domain ?>assets/img/hospital.jpg" alt="Thumb">
                    ...
                    <div class="single-item col-lg-6 col-md-6 mt-3">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo $domain ?>assets/img/hospital-1.jpg" alt="Thumb">
                                </a>
                            </div>
                        </div>
                        <!-- End Single Item -->
                    ...
                    <div class="single-item col-lg-6 col-md-6 mt-3">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo $domain ?>assets/img/hospital-2.jpg" alt="Thumb">
                    ...
                    <div class="single-item col-lg-6 col-md-6 mt-3">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo $domain ?>assets/img/hospital-3.jpg" alt="Thumb">
                    ...
                    <div class="single-item col-lg-6 col-md-6 mt-3">
                        <div class="item">
                            <div class="thumb">
                                <a href="#">
                                    <img src="<?php echo $domain ?>assets/img/hospital.jpg-4.jpg" alt="Thumb">

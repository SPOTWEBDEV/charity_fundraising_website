...
<div class="container">
    <div class="causes-items">
        <div class="row">
            ...
            <div style="height: 400px;" class="single-item col-lg-6 col-md-6 mt-3">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
            ...
            <!-- End Single Item -->
            <!-- Single Item -->
            <div style="height: 400px;" class="single-item col-lg-6 col-md-6">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
                            <img src="<?php echo $domain ?>assets/img/school-4.jpg" alt="Thumb">
            ...
            <div style="height: 400px;" class="single-item col-lg-6 col-md-6 mt-3">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
                            <img src="<?php echo $domain ?>assets/img/school-3.jpg" alt="Thumb">
            ...
            <div style="height: 400px;" class="single-item col-lg-6 col-md-6 mt-3">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
                            <img src="<?php echo $domain ?>assets/img/school-1.jpg" alt="Thumb">

...
if (isset($_GET['edit_id'])) {
         ...
         $select = mysqli_query($connection, "SELECT * FROM `clients` WHERE `id`='$edit_id'");
                                             ...
                                             <div class="card">
                                                      <div class="card-body">
                                                               ...
                                                               if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                                                        ...
                                                                        $verifiactionStatus = $_POST['verifiactionStatus']; // Assuming you added a name attribute to the select element

                                                                        // Update user information in the database
                                                                        $query = "UPDATE clients SET firstname='$firstname', lastname='$lastname', email='$email', phone='$phone', bal='$bal', country='$country', verifiactionStatus='$verifiactionStatus' WHERE id = $edit_id";
                                                                        ...
                                                                        if ($result) {
                                                                                 echo "<script>
                                                                                          window.onload = ()=>{
                                                                                          Model('User information updated successfully!', 'green');
                                                                                 ...
                                                                                 echo "<script>
                                                                                          window.onload = ()=>{
                                                                                          Model('Error updating user information:', 'red');
                                                                                 }
                                                                                          ;
                                                                                          </script>
                                                                                          ";
                                                               ...
                                                               <form method="POST">
                                                                        <div class="grid grid-cols-1 gap-x-5 md:grid-cols-2 xl:grid-cols-3">
                                                                                 <div class="mb-4">
                                                                                          <label for="firstname" class="inline-block mb-2 text-base font-medium">First Name <span class="text-red-500">*</span></label>
                                                                                          <input name="firstname" value="<?php echo $firstname ?>" type="text" id="firstNameInput2" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter First Name" required>
                                                                                 </div>

                                                                                 <div class="mb-4">
                                                                                          <label for="lastname" class="inline-block mb-2 text-base font-medium">Last Name <span class="text-red-500">*</span></label>
                                                                                          <input name="lastname" value="<?php echo $lastname ?>" type="text" id="cityInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Last Name" required>
                                                                                 </div>
                                                                                 <div class="mb-4">
                                                                                 ...
                                                                                 <div class="mb-4">
                                                                                          ...
                                                                                          <input name="phone" type="text" value="<?php echo $phone ?>" id="UsernameInput" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter Phone Number" required>
                                                                                 </div>
                                                                                 <div class="mb-4">
                                                                                          <label for="bal" class="inline-block mb-2 text-base font-medium">Bal <span class="text-red-500">*</span></label>
                                                                                          <input name="bal" type="text" id="UsernameInput" value="<?php echo $bal ?>" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter User Balance" required>
                                                                                 </div>
                                                                                 <div class="mb-4">
                                                                                          <label for="bal" class="inline-block mb-2 text-base font-medium">Country <span class="text-red-500">*</span></label>
                                                                                          <input name="country" type="text" id="UsernameInput" value="<?php echo $country ?>" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter User Country" required>
                                                                                 </div>
                                                                                 <div class="mb-4">
                                                                                          <select name="verifiactionStatus" class="form-select border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200">

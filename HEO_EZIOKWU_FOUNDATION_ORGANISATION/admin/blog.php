...
<head>
  ...
  <title>Create Blog --                                                  <?php echo $sitename ?>
</title>
        ...
        <div class="content-wrapper">
          ...
          <div class="container-xxl flex-grow-1 container-p-y">
            ...
            <h4 class="fw-bold py-3 mb-4">
              <span class="text-muted fw-light">Admin /</span> Create Blog
            </h4>
              ...
              <div class="col-xl">
                <div class="card mb-4">
                  <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Create Blog</h5> <small class="text-muted float-end"></small>
                  </div>
                  <div class="card-body">
...
<form method="POST" id="service-form" enctype="multipart/form-data">
    <div class="mb-3">
        <label class="form-label" for="basic-default-title">Blog Title</label>
        <input type="text" class="form-control" name="title" id="basic-default-title" placeholder="Enter Service Title" required />
    </div>

    <div class="mb-3">
        <label class="form-label" for="basic-default-content">Blog Content</label>

        ...
        <div class="row">
            ...
            <div class="single-item col-lg-6 col-md-6">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
                            <img src="<?php echo $domain ?>assets/img/4.jpg" alt="Thumb">
            ...
            <div class="single-item col-lg-6 col-md-6">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
                            <img src="<?php echo $domain ?>assets/img/5.jpg" alt="Thumb">
            ...
            <div class="single-item col-lg-6 col-md-6">
                <div class="item">
                    <div class="thumb">
                        <a href="#">
                            <img src="<?php echo $domain ?>assets/img/6.jpg" alt="Thumb">

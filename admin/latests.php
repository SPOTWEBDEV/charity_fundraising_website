...
if (isset($_GET['del_id'])) {
         ...
         $delete = mysqli_query($connection, "DELETE FROM latest WHERE id = '$id'");

         // Check if the query was successful
         if ($delete) {
                  // Successful deletion alert
                  echo "<script>alert('Your delete request was successful.'); window.location.href='latests.php';</script>";
         } else {
...
<head>
         ...
         <title>latest List -- <?php echo $sitename ?></title>
                                    ...
                                    <div class="content-wrapper">
                                             ...
                                             <div class="container-xxl flex-grow-1 container-p-y">
                                                      ...
                                                      <h4 class="fw-bold py-3 mb-4">
                                                               <span class="text-muted fw-light">Admin /</span> latest
                                                      </h4>

                                                      <!-- Basic Bootstrap Table -->
                                                      <div class="card">
                                                               <h5 class="card-header">All latests</h5>
                                                               <div class="table-responsive text-nowrap">
                                                                        <table class="table">
                                                                                 ...
                                                                                 <tbody class="table-border-bottom-0">
                                                                                          <?php
                                                                                          $sql = mysqli_query($connection, "SELECT * FROM `latest` ORDER BY date DESC");
                                                                                          ...
                                                                                          ?>
                                                                                                            <tr>
                                                                                                                     ...
                                                                                                                     <td>
                                                                                                                              <img src="<?php echo $imagePath; ?>" alt="latest Image" height="100" style="border-radius: 5px;">
                                                                                                                     </td>
                                                                                                                     <td>
                                                                                          ...
                                                                                          <?php
                                                                                                   ...
                                                                                                   echo "<tr><td class='bg-danger text-white' colspan='6'>No latests Found</td></tr>";
                                                                                          }
                                                                                          ?>
                                                                                 </tbody>
                                                                        </table>
